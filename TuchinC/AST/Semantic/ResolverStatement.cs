...
{
    public partial class Resolver : IVisitor
    {
        ...
        private void ResolveFunctionParams(List<Param> @params)
        {
        ...
        private void ResolveFunctionBody(SyntaxTree node)
        {
        ...
        private void ResolveLocal(Expr expr, Token name)
        {
            ...
            foreach (var scope in _scopes)
            {
                ...
                {
                    ResolveLocals(expr, _scopes.Count - 1 - current);
                    return;
                }
                current--;
            }
        ...
        {
            StructType enclosingClass = _currentStruct;
